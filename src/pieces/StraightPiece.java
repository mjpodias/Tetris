...
/**
 * Class StraightPiece represents the classic Tetris piece shaped like a straight line.
 * Code updated by Pat to create translate, draw, and rotae methods
 */

// class RightAnglePiece
public class StraightPiece implements MoveableShape {
	...
	// default constructor
	public StraightPiece(int xPos, int yPos, int size) {
