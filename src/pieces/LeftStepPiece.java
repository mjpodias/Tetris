...
/**
 * Class LeftStepPiece represents the classic Tetris piece shaped like a stair case going up to the left.
 */

// class RightAnglePiece
public class LeftStepPiece implements MoveableShape {
	...
	private Color color = java.awt.Color.GREEN;

    private int shapeX[] = new int[4];
    private int shapeY[] = new int[4];
	
	// default constructor
	public LeftStepPiece(int xPos, int yPos, int size) {
