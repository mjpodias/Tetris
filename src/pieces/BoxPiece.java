...
/**
 * Class BoxPiece represents the classic Tetris piece shaped like a square.
 */

// class RightAnglePiece
public class BoxPiece implements MoveableShape {
	...
	private Color color = java.awt.Color.BLUE;

    private int shapeX[] = new int[4];
    private int shapeY[] = new int[4];
	
	// default constructor
	public BoxPiece(int xPos, int yPos, int size) {
	...
	public void translate(int dx, int dy) {
		xPos += dx;
		yPos += dy;
		//System.out.println("The piece is at position " + xPos + ", " + yPos);
