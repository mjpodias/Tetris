...
/**
 * Class RightStepPiece represents the classic Tetris piece shaped like a stair case going up to the right.
 */

// class RightAnglePiece
public class RightStepPiece implements MoveableShape {
	...
	// default constructor
	public RightStepPiece(int xPos, int yPos, int size) {
