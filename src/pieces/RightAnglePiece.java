...
/**
 * Class RightAnglePiece represents the classic Tetris piece shaped like an "L".
 */

// class RightAnglePiece
public class RightAnglePiece implements MoveableShape {
    ...
    private Color color = java.awt.Color.ORANGE;

    private int shapeX[] = new int[4];
    private int shapeY[] = new int[4];
	
	// default constructor
	public RightAnglePiece(int xPos, int yPos, int size) {
